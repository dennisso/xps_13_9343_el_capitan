 ...
 *
 * Disassembly of raw/DSDT.aml, Sun Mar  5 13:34:01 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00013544 (79172)
 *     Revision         0x02
 *     Checksum         0x9A
 *     OEM ID           "DELL  "
 *     OEM Table ID     "CBX3   "
...
DefinitionBlock ("", "DSDT", 2, "DELL  ", "CBX3   ", 0x01072009)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xD77EF000, 0x035B)
    ...
    OperationRegion (EXBU, SystemMemory, 0xD79AB000, 0x0010)
    ...
    OperationRegion (DEGA, SystemMemory, 0xD77EE000, 0x0012)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0xD6E91E98, 0x10)
    ...
    OperationRegion (ABNV, SystemMemory, 0xD7498000, 0x000D)
